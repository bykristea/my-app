...
const IndexPage = () => (
  <div>
    <div className="Hero">
      ...
      {/* <div className="Logos">
        <img src={require('../img/pic01.jpg')} width="80" />
        <img src={require('../img/IMG_5931.jpg')} width="80" />
        <img src={require('../img/Face.png')} width="80" />
        <img src={require('../img/IMG_6713.jpg')} width="80" />
        <img src={require('../img/IMG_6714.jpg')} width="80" />
        <img src={require('../img/IMG_6952.jpg')} width="80" />

      </div> */}

      <svg width="100%" height="172"  fill="freeze" xmlns="http://www.w3.org/2000/svg">
      <path  fill="white">
      ...
      <div className="Cards">
        ...
        <div className="CardGroup">
          <Card 
            title="Projects"
            text="take a look"
            image={require('../img/wallpaper5.jpg')} />
          <Card 
            title="Life"
            text=""
          ...
          <Card 
            title="About Me"
            text="Who dis?"
            image={require('../img/wallpaper7.jpg')} />
